...
lambda0 = 100;
lambda = lambda0*ones(d+1,T);   % regularization coefficient on the spikes (s_t's)
...
PolyPCA_messages('autoregression',theta)
PolyPCA_messages('penalty',penalty,lambda0)
PolyPCA_messages('saddle',saddleSigma)
